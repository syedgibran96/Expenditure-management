...
<body>
  ...
  <ul>
	...
	<li><a href="insertf.html">Insert</a></li>
    <li><a href="chartsf/foodb.php">Bar</a></li>
    <li><a href="chartsf/foodp.php">Pie</a></li>
    <li><a href="chartsf/foodd.php">Donut</a></li>
    </ul>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      $('.editmanager').click(function () {
          ...
          var i=1;               
              ...
              var id=this.value;
            window.location.href = "updatef.php?id="+id+"&category="+category+"&cost="+cost+"&date="+date;
          }
...
$result= mysqli_query($conn,$res);
                ...
                while($row=mysqli_fetch_array($result))
                {
                    ...
                    echo "<td>".$row['cost']."</td>";
                    echo "<td>".$row['date']."</td>";
                    print("<td><a class='button' href='deletef.php?id=".$row['id']."'>delete</a></td>");
